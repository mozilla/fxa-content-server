...
define(function (require, exports, module) {
  ...
  describe('views/sign_in', () => {
    ...
    describe('submit', () => {
      ...
      describe('with hard email bounce error', () => {
        ...
        it('navigated to the signin-bounced screen', () => {
          ...
          assert.deepEqual(view.navigate.args[0][1], { email });
          assert.equal(view.displayError.callCount, 0);
        });
      });

      describe('with soft email bounce error', () => {
        let succeeded, err;
        ...
        it('displayed the error', () => {
          ...
          assert.equal(view.displayError.args[0][0], err);
          assert.equal(view.navigate.callCount, 0);
        });
      });

      describe('with email complaint error', () => {
        let succeeded, failed;
