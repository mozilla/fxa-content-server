...
define(function (require, exports, module) {
  ...
  const FxDesktopV1Broker = require('models/auth_brokers/fx-desktop-v1').Constructor;
  const FxDesktopV2Broker = require('models/auth_brokers/fx-desktop-v2').Constructor;
  const FxFennecV1Broker = require('models/auth_brokers/fx-fennec-v1').Constructor;
  const FxFirstrunV1Broker = require('models/auth_brokers/fx-firstrun-v1').Constructor;
  const FxFirstrunV2Broker = require('models/auth_brokers/fx-firstrun-v2').Constructor;
  const FxiOSV1Broker = require('models/auth_brokers/fx-ios-v1').Constructor;
  ...
  const RedirectBroker = require('models/auth_brokers/redirect').Constructor;
