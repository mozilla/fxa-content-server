...
define([
  ...
  'views/base',
  '../../../mocks/window'
], function (chai, sinon, _, FxDesktopBroker, Relier, Constants,
        AuthErrors, NullChannel, p, Session, BaseView, WindowMock) {
  ...
  describe('models/brokers/fx-desktop', function () {
    ...
    describe('afterSignUpConfirmed', function () {
      it('notifies the channel of login and redirects to `/signup_complete`', function () {
        sinon.stub(broker, 'notifyOfLogin', function () {
          return p();
        });
