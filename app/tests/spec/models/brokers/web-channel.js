...
function (chai, sinon, WebChannelBroker, Relier, p, NullChannel, Session,
      BaseView, WindowMock) {
  var assert = chai.assert;

  describe('models/brokers/web-channel', function () {
    var broker;
    var windowMock;
    var relierMock;
    var channelMock;
    ...
    describe('shouldReadyScreenAutoSubmit', function () {
      it('should return true', function () {
        assert.isTrue(broker.shouldReadyScreenAutoSubmit());
      });
    });
    ...
    describe('finishOAuthFlow', function () {
      ...
      describe('getChannel', function () {
        it('creates a WebChannel with the id set in the broker', function () {
          var broker = new WebChannelBroker({
