...
define([
  ...
  var DO_NOT_CLEAR = ['channel', 'context', 'service', 'config', 'language', 'native_channel'];

  // these keys will be persisted to localStorage so that they live between browser sessions
  var PERSIST_TO_LOCAL_STORAGE = ['email', 'sessionToken', 'sessionTokenContext', 'oauth', 'native_channel'];
