...
define(function (require, exports, module) {
  ...
  var CompleteSignInTemplate = require('stache!templates/complete_sign_in');
  ...
  var CompleteSignInView = FormView.extend({
    template: CompleteSignInTemplate,
    className: 'complete_sign_in',
    ...
    beforeRender: function () {
      ...
      return self.user.completeAccountSignIn(self.getAccount(), code)
          .then(function () {
    ...
    submit: function () {
      ...
      return account.retrySendSignInCode(
        self.relier,
        {
  ...
  module.exports = CompleteSignInView;
});
