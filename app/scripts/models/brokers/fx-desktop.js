...
define([
  ...
  'lib/constants'
], function (_, DefaultBroker, ChannelMixin, p, AuthErrors,
        FxDesktopChannel, Constants) {

  var FxDesktopBroker = DefaultBroker.extend({
    initialize: function (options) {
      ...
      return DefaultBroker.prototype.initialize.call(this, options);
    },

    fetch: function () {
      var self = this;

      return DefaultBroker.prototype.fetch.call(self)
        .then(function () {
          ...
          return self.send('session_status', {})
            ...
            .then(_.bind(self.initializeSession, self));
        });
    },

    initializeSession: function (sessionStatus) {
      var self = this;
    ...
    afterSignUpConfirmed: function (view) {
      return this.notifyOfLogin()
        .then(function () {
          return view.navigate('signup_complete');
        });
    },
  ...
  _.extend(FxDesktopBroker.prototype, ChannelMixin);
